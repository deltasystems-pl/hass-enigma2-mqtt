...
| [0003](0003-control-feedback-and-household-features.md) | Control feedback and household features — the 0.2.0 and 0.3.0 plan | accepted, extended by [ADR-0004](0004-remote-uninstall.md) |
| [0004](0004-remote-uninstall.md) | Remote uninstall behind a box-side permission | accepted, implementation pending |
