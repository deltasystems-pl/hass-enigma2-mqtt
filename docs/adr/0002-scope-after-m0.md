...
> in 0.2.0, whose opt-in release check (off by default) asks the plugin repository which release is
> published; nothing recorded that at the time, and ADR-0008 does. Until ADR-0008 is accepted and
